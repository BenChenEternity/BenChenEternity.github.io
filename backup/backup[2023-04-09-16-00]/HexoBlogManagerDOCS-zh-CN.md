...
因为面向大部分用户，所以操作系统为 Windows，不支持Linux和MAC
...
![PIC8](HexoBlogManagerDOCS-zh-CN/8.webp)

第一个输入框填写您的hexo博客的根目录

第二个输入框填写您的cwebp的根目录。

#### 什么是cwebp？

cwebp是一个可将图片文件压缩为 WebP 文件的工具

[单机此处可下载 WebP for windows](https://storage.googleapis.com/downloads.webmproject.org/releases/webp/libwebp-1.3.0-windows-x64.zip)
